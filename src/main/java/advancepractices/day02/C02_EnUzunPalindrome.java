...
public class C02_EnUzunPalindrome {
    public static void main(String[] args) {

        /*
        Verilen str datadaki en uzun palindrome 'u veren kodu yaziniz (Palindrom, tersten okunuşu da aynı olan cümle, sözcük ve sayılara denilmektedir.)
